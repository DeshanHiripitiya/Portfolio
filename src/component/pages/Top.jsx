...
function Top({ projectsRef, contactRef }) {
  ...
  return (
    ...
    >
      <div
        className='flex sm:flex-col-reverse md:flex-row items-center justify-center m-auto gap-16 p-8 
      sm:px-20 
      md:p-10 md:gap-0
      lg:p-10 lg:gap-10'
      >
        <div className=''>
          <div>
            ...
            <p
              className='font-poppins font-bold mt-5 text-4xl
            xl:text-5xl'
            >
            ...
            <p
              className='font-poppins font-bold text-[#0E4DA4] mt-3.5 text-3xl
            lg:text-5xl
            xl:text-6xl'
            >
            ...
            <p
              className='font-poppins font-bold mt-3 text-3xl 
            lg:text-4xl
            xl:text-5xl'
            >
            ...
            <motion.p
              ...
              className='font-normal font-poppins mt-6 text-base text-center 
              sm:text-left
              xl:text-lg '
            >
              ...
              makes the journey easier, turning it
        ...
        <div className='hidden sm:block items-center'>
          <img
            ...
            alt='Logo'
            className='md:h-1/4 sm:h-[20rem] lg:h-1/6'
          />
        </div>
      </div>
    </div>
